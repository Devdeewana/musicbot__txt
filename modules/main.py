...
async def account_login(bot: Client, m: Message):
    editable = await m.reply_text(f"BOT MADE BY - DEV  [{m.from_user.first_name}](tg://user?id={m.from_user.id})\nGIVE COMMAND - /DEV")
...
@bot.on_message(filters.command(["DEV"]) & SUDOERS)
async def account_login(bot: Client, m: Message):
